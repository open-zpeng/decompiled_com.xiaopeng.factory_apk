...
public class SolarTerms {
    ...
    public static int getTerm(int y, int n) {
        ...
        for (int i = 0; i < 6; i++) {
            _info[i] = Integer.valueOf(Integer.parseInt(_table.substring(i * 5, (i + 1) * 5), 16));
        }
        String[] _calday = new String[24];
        for (int i2 = 0; i2 < 6; i2++) {
            _calday[i2 * 4] = _info[i2].toString().substring(0, 1);
            _calday[(i2 * 4) + 1] = _info[i2].toString().substring(1, 3);
            _calday[(i2 * 4) + 2] = _info[i2].toString().substring(3, 4);
            _calday[(i2 * 4) + 3] = _info[i2].toString().substring(4, 6);
        }
    ...
    private static String getTermInternal(int year, int mouth, int day) {
        ...
        String[] segmentTable = {termInfoStr.substring(0, 1), termInfoStr.substring(1, 3), termInfoStr.substring(3, 4), termInfoStr.substring(4, 6)};

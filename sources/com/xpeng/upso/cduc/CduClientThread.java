...
public class CduClientThread extends Thread {
    public static final String TAG = "Upso-CduCT";
    ...
    public CduClientThread(Context context, int op, ProxyParamWrapper paramIn) {
    ...
    private void communicate() {
        ...
        CduClientRequestHandler cduClientRequestHandler = new CduClientRequestHandler(this.context, this.socket, this.carModel, this.chipModel, this.op);
        do {

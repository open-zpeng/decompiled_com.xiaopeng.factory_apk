...
public class XpuClientPreset extends XpengKeyStore {
    private static final String TAG = "Upso-XPU_Preset";

    public XpuClientPreset() {
    ...
    public String genAlias(long index, XpengCarModel carModel, XpengCarChipModel chipModel) {
        String keyIndexS = "xpuxpeng_alias_" + carModel.toString() + "_" + chipModel.toString() + ProxyConstants.ALIAS_PLAIN_POSTFIX + index;

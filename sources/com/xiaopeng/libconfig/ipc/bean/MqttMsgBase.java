...
public class MqttMsgBase<T> {
    ...
    public String toString() {
        return "MqttMsgBase{msg_id='" + this.msg_id + CharPool.SINGLE_QUOTE + ", msg_ref='" + this.msg_ref + CharPool.SINGLE_QUOTE + ", msg_type=" + this.msg_type + ", service_type=" + this.service_type + ", msg_content=" + this.msg_content + '}';
    }
}

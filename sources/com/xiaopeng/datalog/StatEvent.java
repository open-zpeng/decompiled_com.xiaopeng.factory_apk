...
public class StatEvent implements IStatEvent {
    ...
    public static String getVersion(Context context) {
        if (TextUtils.isEmpty(sVersion)) {
            try {
                ...
                return Support.Properties.PROPERTIES_DEFAULT_STRING;
            }
        }
        return sVersion;
    }
    ...
    public String toString() {
        return "StatEvent{eventName='" + this.eventName + CharPool.SINGLE_QUOTE + '}';
    }
            ...
            if (info.getType() == 0) {
                switch (info.getSubtype()) {
                    ...
                    default:
                        return "";
                    case 13:
                        return Constant.BURNTEST.TEST_4G;
                }
            } else if (info.getType() == 1) {
                return Constant.BURNTEST.TEST_WIFI;
            } else {
                return "";
            }
        }

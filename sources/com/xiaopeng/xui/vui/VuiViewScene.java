...
public abstract class VuiViewScene implements IVuiViewScene, IVuiSceneListener {
    ...
    public /* synthetic */ void lambda$onBuildScene$0$VuiViewScene() {
        ...
        if (vuiEngine != null && sceneId != null && rootView != null) {
            log("onBuildScene");
            onBuildScenePrepare();
            vuiEngine.buildScene(sceneId, rootView, this.customViewIds, this.mVuiElementListener);
        }
    }
    ...
    private void log(String msg) {
        XLogUtils.d("VuiViewScene", " mSceneId " + this.mSceneId + Constant.SPACE_2_STRING + msg + " hashcode " + hashCode() + " name " + getClass().getSimpleName());
    }

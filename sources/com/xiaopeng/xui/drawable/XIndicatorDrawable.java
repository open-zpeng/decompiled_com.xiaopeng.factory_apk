...
public final class XIndicatorDrawable extends Drawable {
    ...
    public /* synthetic */ void lambda$new$0$XIndicatorDrawable(ValueAnimator animation) {
        ...
        float f = this.mIndicatorStart;
        this.mIndicatorStart = f + ((this.mAnimIndicatorStart - f) * progress);
        float progress2 = this.mIndicatorEndAnimSpeed * value;
        if (progress2 > 1.0f) {
            progress2 = 1.0f;
        }
        float f2 = this.mIndicatorEnd;
        this.mIndicatorEnd = f2 + ((this.mAnimIndicatorEnd - f2) * progress2);
        invalidateSelf();
    }

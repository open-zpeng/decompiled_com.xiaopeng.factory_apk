...
public class XFrameLayout extends FrameLayout implements VuiView {
    ...
    public XFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {

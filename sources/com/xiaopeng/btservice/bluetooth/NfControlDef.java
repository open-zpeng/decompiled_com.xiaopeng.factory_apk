...
public class NfControlDef {
    ...
    public static final int CAT_COMPUTER = 1;
    public static final int CAT_MONO_AUDIO = 8;
    public static final int CAT_PHONE = 2;
    public static final int CAT_STEREO_AUDIO = 4;

...
public class CertVerifyModel {
    ...
    public CertVerifyModel(String clientCertPath, String rootCertPath, String url, String clientPassword) {
    ...
    public CertVerifyModel(String clientCertPath, String rootCertPath, String url, String clientPassword, boolean clientBaseEncode, boolean caBaseEncode) {
        this.mClientCertPath = clientCertPath;
        this.mRootCertPath = rootCertPath;
        this.mVerifyUrl = url;
        this.mClientPassword = clientPassword;
    ...
    public boolean verifyCert() {
        try {
            ...
            Response response = buildOkHttpClient(MyApplication.getContext()).newCall(request).execute();
    ...
    public void verifyCert(final ICallback<String, String> callback) {
        Request request = new Request.Builder().url(this.mVerifyUrl).get().build();
        buildOkHttpClient(MyApplication.getContext()).newCall(request).enqueue(new Callback() { // from class: com.xiaopeng.factory.model.security.CertVerifyModel.1
    ...
    public class CompositeX509TrustManager implements X509TrustManager {
        ...
        */
        public CompositeX509TrustManager(java.lang.String r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xiaopeng.factory.model.security.CertVerifyModel.CompositeX509TrustManager.<init>(com.xiaopeng.factory.model.security.CertVerifyModel, java.lang.String):void");
        }

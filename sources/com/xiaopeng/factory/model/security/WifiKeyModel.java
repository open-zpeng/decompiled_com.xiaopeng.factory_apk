...
public class WifiKeyModel {
    ...
    public void asyncGetKey(final Runnable callback) {
        ...
        ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.factory.model.security.-$$Lambda$WifiKeyModel$KSYnAIsMz03GKcM74cT1weTwJ8E
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0038, code lost:
        com.xiaopeng.lib.utils.LogUtils.i(com.xiaopeng.factory.model.security.WifiKeyModel.TAG, "get key");
     */
    /*
    ...
    */
    public /* synthetic */ void lambda$asyncGetKey$0$WifiKeyModel(java.lang.Runnable r9) {
        ...
        L4:
            ...
            boolean r4 = r8.mNeedRequestWifiKey     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            r2.append(r4)     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            ...
            boolean r2 = r8.mNeedRequestWifiKey     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            if (r2 == 0) goto L2d
            r8.mNeedRequestWifiKey = r5     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            ...
            r8.reqWifiKey(r2)     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
        L2d:
            r6 = 10500(0x2904, double:5.1877E-320)
            java.lang.Thread.sleep(r6)     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            boolean r2 = r8.isWifiKeyExist()     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            if (r2 == 0) goto L3e
        ...
        L5a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaopeng.factory.model.security.WifiKeyModel.lambda$asyncGetKey$0$WifiKeyModel(java.lang.Runnable):void");
    }
    ...
    /* renamed from: com.xiaopeng.factory.model.security.WifiKeyModel$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    public class AnonymousClass1 implements Callback {
        ...
        public void onSuccess(final IResponse iResponse) {
            ...
            ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.factory.model.security.-$$Lambda$WifiKeyModel$1$KRA8ioIgsidGV4-OokJsCSIzsck
                @Override // java.lang.Runnable
                public final void run() {

...
public class SimpleAwsUploadTask extends BaseAwsTask {
    ...
    private void UpdateUploadInfo(UploadInfo uploadInfo) {
        if (this.mCallbackParams == null || this.mCallbackParams.isEmpty() || this.mCallbackParams.get("callbackBody") == null || !XMART_OSSFILE_URL.equals(this.mCallbackParams.get("callbackUrl"))) {
            return;
        }
        try {
            UploadInfo callbackUploadInfo = (UploadInfo) new Gson().fromJson(this.mCallbackParams.get("callbackBody"), (Class<Object>) UploadInfo.class);
    ...
    private JsonObject wrapJsonBody(UploadInfo uploadInfo) {
        ...
        jsonObject.addProperty(URLUtil.URL_PROTOCOL_FILE, uploadInfo.file);
    ...
    private String createSign(String file, String timestamp) {
        String appString = URLUtil.URL_PROTOCOL_FILE + file + "type" + UploadInfo.UPLOAD_TYPE + "v2";

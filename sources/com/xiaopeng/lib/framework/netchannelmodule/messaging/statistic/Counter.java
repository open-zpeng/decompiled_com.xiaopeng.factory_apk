...
public class Counter {
    ...
    public void increaseTryingToPublish() {
        ...
        if (unpublished >= UNPUBLISHED_COUNT_THRESHOLD && ((unpublished >> 6) << 6) == unpublished) {

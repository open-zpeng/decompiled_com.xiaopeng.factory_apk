...
public class TrafficStatsEntry {
    ...
    static {
        sEntry.clear();
        sEntry.put(IpcConfig.App.CAR_OTA, new Entry(FIRST_NETWORK_UID, TAG_APP_OTA));
        sEntry.put(Constant.PACKAGE_NAME_OOBE, new Entry(100001, TAG_APP_OOBE));
        ...
        sEntry.put("com.xiaopeng.devtools", new Entry(IpcConfig.CarInfoUploadConfig.TYPE_IMMEDIATELY_GET_CARINFO_DATA_REQUEST, TAG_APP_DEV_TOOLS));
        ...
        sEntry.put(Constant.PACKAGE_NAME_SETTING, new Entry(100016, TAG_APP_CAR_SETTINGS));
        ...
        sEntry.put(Constant.PACKAGE_NAME_FACTORYTEST, new Entry(100022, TAG_APP_FACTORY));

...
public class AppResourceResponse {
    ...
    public String toString() {
        ...
        try {
            ...
            object.put(Constant.MCUTEST.MCU_SERVER_CONNECTION_RESULT_TAG, this.mResult);
    ...
    public static AppResourceResponse from(String src) {
        try {
            if (!TextUtils.isEmpty(src)) {
                ...
                response.mResult = object.optString(Constant.MCUTEST.MCU_SERVER_CONNECTION_RESULT_TAG);

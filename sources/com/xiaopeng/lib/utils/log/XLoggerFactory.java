...
public class XLoggerFactory {
    ...
    public static class XLoggerBuilder {
        ...
        public String toString() {
            return "XLoggerBuilder{context=" + this.context + ", filePath='" + this.filePath + CharPool.SINGLE_QUOTE + ", filePrefix='" + this.filePrefix + CharPool.SINGLE_QUOTE + ", mode=" + this.mode + ", level=" + this.level + ", flushInterval=" + this.flushInterval + ", maxTotalSize=" + this.maxTotalSize + '}';
        }
    }
}

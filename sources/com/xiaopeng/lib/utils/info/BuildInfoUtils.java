...
import com.xiaopeng.commonfunc.utils.PcCmdUtil;
...
public class BuildInfoUtils {
    ...
    public static String getHardwareId() {
        return getString(SysPropUtils.SYS_PROP_CDUID);
    }
    ...
    public static boolean isUserVersion() {
        return Constant.BUILD_TYPE_USER.equals(Build.TYPE);
    }
    ...
    static boolean isDeviceApproved() {
        ...
        return "XiaoPeng".equals(deviceInfo) || PcCmdUtil.CMD_PREFIX.equals(deviceInfo);
    }

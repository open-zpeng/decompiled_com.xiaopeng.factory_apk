...
public class DateUtils {
    ...
    private static SimpleDateFormat sSimpleFormat3 = new SimpleDateFormat(DatePattern.CHINESE_DATE_PATTERN);
    private static SimpleDateFormat sSimpleFormat4 = new SimpleDateFormat("yyyy.MM.dd");
    private static SimpleDateFormat sSimpleFormat5 = new SimpleDateFormat(DatePattern.NORM_TIME_PATTERN);
    private static SimpleDateFormat sTimeSimpleFormat = new SimpleDateFormat("HH:mm");
    private static SimpleDateFormat sBirthdaySimpleFormat = new SimpleDateFormat(DatePattern.NORM_DATE_PATTERN);

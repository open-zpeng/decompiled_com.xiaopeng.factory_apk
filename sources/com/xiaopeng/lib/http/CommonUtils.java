...
public class CommonUtils {
    ...
    public static final String CAR_CLIENT_DEFAULT = Constant.HTTP_CAR_XMART + BuildInfoUtils.getSystemVersion();

    static {
        if (Build.VERSION.SDK_INT == 19) {
            ACTION_BROADCAST_ISF_SECURE_STORE_RELOAD = IndivHelper.ACTION_BROADCAST_ISF_SECURE_STORE_RELOAD;
        } else {
            ACTION_BROADCAST_ISF_SECURE_STORE_RELOAD = "com.xiaopeng.action.SECURE_STORE_RELOAD";
        }
    }

...
import com.xiaopeng.commonfunc.model.test.callback.CarCallback;
...
public class RadioTest {
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() { // from class: com.xiaopeng.commonfunc.model.test.RadioTest.1
    ...
    private CarRadioManager.CarRadioEventCallback mCarRadioEventCallback = new CarRadioManager.CarRadioEventCallback() { // from class: com.xiaopeng.commonfunc.model.test.RadioTest.2

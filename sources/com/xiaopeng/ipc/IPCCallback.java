...
public interface IPCCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPCCallback {
        ...
        public static IPCCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof IPCCallback)) {
                return (IPCCallback) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (data.readInt() != 0) {
                _arg0 = IpcMessage.CREATOR.createFromParcel(data);
            } else {
                _arg0 = null;
            }
            onReceive(_arg0);

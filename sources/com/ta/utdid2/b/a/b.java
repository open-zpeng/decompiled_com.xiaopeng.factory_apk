...
public class b {
    ...
    public static byte[] decode(byte[] input, int offset, int len, int flags) {
        C0019b c0019b = new C0019b(flags, new byte[(len * 3) / 4]);
        if (!c0019b.a(input, offset, len, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (c0019b.a == c0019b.b.length) {
            return c0019b.b;
        }
        byte[] bArr = new byte[c0019b.a];
        System.arraycopy(c0019b.b, 0, bArr, 0, c0019b.a);
        return bArr;
    }

...
class e {
    ...
    public static final void a(Map map, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        if (map == null) {
            xmlSerializer.startTag(null, CharSequenceUtil.NULL);
            xmlSerializer.endTag(null, CharSequenceUtil.NULL);
            return;
        }
    ...
    public static final HashMap m115a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m116a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals(CharSequenceUtil.NULL)) {
            if (name.equals("string")) {
                ...
                xmlPullParser.next();
                int[] m116a = m116a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m116a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m115a = m115a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m115a;

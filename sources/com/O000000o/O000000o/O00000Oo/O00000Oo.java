...
public final class O00000Oo {
    ...
    /* loaded from: classes.dex */
    public static final class C0001O00000Oo implements Serializable, ParameterizedType {
        private static final long O00000o = 0;
        private final Type O000000o;
        private final Type O00000Oo;
        private final Type[] O00000o0;

        public C0001O00000Oo(Type type, Type type2, Type... typeArr) {
            int i = 0;
        ...
        public String toString() {
            ...
            sb.append("<");
            sb.append(O00000Oo.O00000oo(this.O00000o0[0]));
            for (int i = 1; i < this.O00000o0.length; i++) {
                sb.append(", ");
                sb.append(O00000Oo.O00000oo(this.O00000o0[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class O00000o0 implements Serializable, WildcardType {
        ...
        public String toString() {
            ...
            sb.append(O00000Oo.O00000oo(type));
            return sb.toString();
        }
    }
    ...
    public static ParameterizedType O000000o(Type type, Type type2, Type... typeArr) {
        return new C0001O00000Oo(type, type2, typeArr);
    }
    ...
    */
    ...
    public static Type O00000o(Type type) {
        if (type instanceof Class) {
            ...
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new C0001O00000Oo(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
    ...
    public static Class<?> O00000oO(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            String name = type == null ? CharSequenceUtil.NULL : type.getClass().getName();

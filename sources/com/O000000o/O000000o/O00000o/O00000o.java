...
public class O00000o implements Closeable, Flushable {
    ...
    */
    ...
    public O00000o O000000o(boolean z) throws IOException {
        O0000Oo();
        O00000oO(false);
        this.O00000o0.write(z ? "true" : BooleanUtils.FALSE);
        return this;
    }
    ...
    public O00000o O00000o() throws IOException {
        O0000Oo();
        return O000000o(3, StrPool.DELIM_START);
    }
    ...
    public O00000o O00000oO() throws IOException {
        return O000000o(3, 5, StrPool.DELIM_END);
    }
    ...
    public O00000o O00000oo() throws IOException {
        ...
        O00000oO(false);
        this.O00000o0.write(CharSequenceUtil.NULL);
        return this;
    }

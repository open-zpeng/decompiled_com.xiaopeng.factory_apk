...
final class O000000o implements O0000o<Date>, O000OOOo<Date> {
    ...
    O000000o(DateFormat dateFormat, DateFormat dateFormat2) {
        ...
        this.O00000o0 = new SimpleDateFormat(DatePattern.UTC_PATTERN, Locale.US);
        this.O00000o0.setTimeZone(TimeZone.getTimeZone("UTC"));
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new O000OOo(o00oOooO.O00000o(), e3);
                    }
                }
            }
        }
    ...
    public String toString() {
        return O000000o.class.getSimpleName() + '(' + this.O00000Oo.getClass().getSimpleName() + ')';
    }
}

...
public final class AnimatorSet extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo100clone() {
        AnimatorSet anim = (AnimatorSet) super.mo100clone();
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m101clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo100clone();
                return node;

...
public class UTHybridHelper {
    ...
    private void a(Date date, Map<String, String> map, Object obj) {
        ...
        int i = 2006;
        if (UTPageHitHelper.getInstance().m120a(obj)) {
            i = 2001;
        }
        ...
        UTPageHitHelper.getInstance().m119a(obj);
    }
    ...
    private void a(Date date, Map<String, String> map) {
        ...
        UTOriginalCustomHitBuilder uTOriginalCustomHitBuilder = new UTOriginalCustomHitBuilder(b, AMapException.CODE_AMAP_NEARBY_KEY_NOT_BIND, str, null, null, e);
        UTTracker defaultTracker = UTAnalytics.getInstance().getDefaultTracker();
        if (defaultTracker != null) {
            defaultTracker.send(uTOriginalCustomHitBuilder.build());
        } else {

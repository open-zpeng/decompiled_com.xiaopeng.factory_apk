...
public class UTPageHitHelper {
    ...
    private String m117a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m120a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m119a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m117a = m117a(obj);
        if (this.A.containsKey(m117a)) {
            return this.A.get(m117a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m117a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m117a);
    ...
    private synchronized void m118b(Object obj) {
        String m117a = m117a(obj);
        if (this.A.containsKey(m117a)) {
            this.A.remove(m117a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m117a = m117a(obj);
            if (m117a != null && m117a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
